...
blocks:title: Tina Cloud Starter

  - background: ""blocks:

    headline: Welcome to My Tech Blog  - background: ""

    tagline: Sharing insights on web development and technology    text: Support for live editing and editorial workflow

    actions:    url: "https://tina.io/editorial-workflow"

      - label: Read Posts    _template: callout

        type: button  - background: bg-orange-50/80

        icon:    headline: Welcome to the TinaCloud Starter

          name: BiBookOpen    tagline: Build 10x Faster with TinaCMS
