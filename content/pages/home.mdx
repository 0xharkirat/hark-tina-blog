...
blocks:
  ...
  - background: ""blocks:title: Tina Cloud Starter

    headline: Harkirat Singh

    tagline: Software Engineer building mobile, web, and backend solutions  - background: ""blocks:

    actions:

      - label: Read My Blog    headline: Welcome to My Tech Blog  - background: ""

        type: button

        link: /posts    tagline: Sharing insights on web development and technology    text: Support for live editing and editorial workflow

      - label: About Me

        type: link    actions:    url: "https://tina.io/editorial-workflow"

        link: /about

    _template: hero      - label: Read Posts    _template: callout

  - background: ""

    body:        type: button  - background: bg-orange-50/80

      type: root

      children:        icon:    headline: Welcome to the TinaCloud Starter

        - type: p

          children:          name: BiBookOpen    tagline: Build 10x Faster with TinaCMS

            - type: text

              text: "I'm a Software Engineer at SSW, specializing in mobile app development with Flutter and Firebase, backend development with C# .NET, and web applications using Angular."          color: white    actions:

    _template: content

---        link: /posts      - label: Get Started


      - label: About Me        type: button

        type: link        icon:

        link: /about          name: Tina

    _template: hero          color: white

  - background: bg-neutral-50        link: /about

    body:      - label: Read Blog
      ...
      children:        link: /posts
        ...
        - type: p    image:
          ...
          children:      src: ""
            ...
            - type: text      alt: Getting started with TinaCMS

              text: "This is a minimal tech blog built with TinaCMS and Next.js. Here you'll find articles about web development, programming, and technology."      videoUrl: "https://www.youtube.com/embed/j8egYW7Jpgk"

    _template: content    _template: hero
